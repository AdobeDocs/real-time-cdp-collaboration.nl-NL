...
>abstract="Het aantal unieke id&#39;s in het publiek van uw medewerker, op basis van de sleutels die u en uw medewerker voor het project hebben overeengekomen."

>[!CONTEXTUALHELP]
>id="rtcdp_collaboration_discover_overlapping_identities_count"
>title="Aantal overlappende identiteiten"
>abstract="Het aantal unieke id&#39;s dat aanwezig is in het publiek van zowel uw medewerker als uw medewerker, op basis van de sleutels die u en uw medewerker hebben overeengekomen voor het project."

>[!CONTEXTUALHELP]
>id="rtcdp_collaboration_discover_overlapping_identities_percentage"
>title="Percentage overlappende identiteiten"
>abstract="Het percentage overlappende identiteiten tussen u en het geselecteerde publiek van uw medewerker."
...
|---------|----------|
| **[!UICONTROL Identity count]** (van u) | Het aantal unieke id&#39;s in uw geselecteerde publiek of publiek. |
...
Als de score van de publieksindex voor om het even welk publiek van uw medewerker wordt toegelaten, zal het relevante publiek op de score van de publieksindex worden gebaseerd, en om het even welk publiek waar de publieksindex niet is toegelaten zal niet worden omvat. Relevante doelgroepen op basis van de score van de publieksindex worden gesorteerd, zodat de hoogste indexscore als eerste wordt weergegeven. Als de publieksindex niet is ingeschakeld voor een publiek in uw medewerker, wordt het relevante publiek gebaseerd op het percentage voor overlapping.
...
>abstract="Krijg inzicht in overlappingen tussen uw publiek en het publiek van uw medewerker."
...
## Poortindexscore {#audience-index-score}

>[!CONTEXTUALHELP]
>id="rtcdp_collaboration_discover_audience_index_score"
>title="Poortindexscore"
>abstract="De indexscores van het publiek zijn genummerde metrisch die toont hoe sterk één publiek op een andere gebaseerd op onderliggende publiekscijfers en overlappingen verhoudt. De onbewerkte indexscore wordt vertaald in relevantiebanden, die de scores van de publieksindex van zeer laag tot zeer hoog categoriseren. Hierdoor kunt u snel de kracht van de relatie tussen uw publiek en het publiek van uw medewerker beoordelen."

De indexscores van het publiek zijn genummerde metrisch die toont hoe sterk één publiek op een andere gebaseerd op onderliggende publiekscijfers en overlappingen verhoudt. Dit helpt u publieksinzichten contextualiseren en high-potential publiek voor prospecting en campagne het richten identificeren.
...
| Publiek CTV-uitgever | Formule | Indexscore (i) | Interpretatie |
|------------------------|-------------|----------------|----------------|
| Basislijn (alle soorten publiek) | (1,3 MB / 1,3 MB) / (50 MB / 50 MB) * 100 | 100 | Dit fungeert als de basislijn waarmee het andere publiek van uw medewerker wordt vergeleken. |
| Binge Watchers | (500 k / 1,3 m) / (20 m / 50 m)) * 100 | 96 | Door dit publiek aan te spreken, is de kans dat SUV-eigenaars 4% minder groot dan bij de basislijn. |
| Comedy Lovers | (200 k / 1,3 m) / (6 MB / 50 m)) * 100 | 128 | Door dit publiek te richten, bent u 28% waarschijnlijker SUV-eigenaars te bereiken in vergelijking met de basislijn. |
| Malen 25-34 | (700 k / 1,3 m) / (12 m / 50 m)) * 100 | 224 | Door dit publiek te richten, bent u 124% waarschijnlijker om SUV-eigenaars in vergelijking met de basislijn te bereiken. |
| Technische liefhebbers | (500 k / 1,3 m) / (8 m / 50 m)) * 100 | 240 | Als u zich op dit publiek richt, bereikt u 140% meer SUV-eigenaars dan de basislijn. |

{style="table-layout:auto"}

Om beter te begrijpen hoe de indexscores uw campagne zullen beïnvloeden, worden de relevantiebanden verstrekt naast de scores.

### Relevante banden {#audience-index-relevance-bands}
...
| 120 &lt; i &lt; 140 | Hoog | De overlapping komt vaker voor bij het doelpubliek dan bij uw publiek, wat een sterke relatie laat zien. Klanten die dit publiek gebruiken, zullen hun doelpubliek eerder bereiken. |
| i > 140 | Zeer hoog | De overlapping komt veel vaker voor in het doelpubliek dan in uw publiek, wat een zeer sterke relatie weerspiegelt. Klanten die dit publiek gebruiken, zullen hun doelpubliek veel waarschijnlijker bereiken. |

{style="table-layout:auto"}

In de sectie over overlappingen ontdekken wordt de score van de publieksindex naast de score weergegeven. De score wordt in kleur gecodeerd om de relevantieband aan te geven, zodat u de sterkte van de relatie in één oogopslag gemakkelijk kunt herkennen. Zeer lage en lage relevantiebanden worden in oranje, gemiddelde relevantiebanden in zwart weergegeven en in groene, en zeer belangrijke banden.
