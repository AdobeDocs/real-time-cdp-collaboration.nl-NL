...
Om extra organisaties toe te voegen, navigeer aan **[!UICONTROL Setup]** in het linkerspoor en selecteer toe:voegen pictogram (![&#x200B; voeg pictogram toe.](/help/assets/icons/plus.png)) in de rechterbovenhoek. Selecteer vervolgens **[!UICONTROL Account]** .
...
>abstract="Apparaat-id&#39;s van de eerste partij, zoals ECID- of IP-adressen, zijn rechtstreeks verbonden met apparaten die kunnen worden gedeeld tussen verschillende personen."
...
* **[!UICONTROL IDFA]**: De id voor adverteerders (IDFA) die wordt gebruikt in Apple iOS-apparaten
...
Als u **[!UICONTROL AdFixus ID]** selecteert, moet u de bijbehorende id opgeven van uw externe partner in de sectie **[!UICONTROL Account credentials]** . Deze optie zal slechts beschikbaar zijn *na* het van een knevel voorzien **[!UICONTROL AdFixus ID]**. Voer uw AdFixus-id in het veld **[!UICONTROL Account ID]** in. Controleer de waarde op nauwkeurigheid.

![&#x200B; de de sleuteldialoog van de Gelijke met identiteitskaart AdFixus die en de benadrukte sectie van de geloofsbrieven van de Rekening wordt in- en uitgeschakeld.](/help/assets/setup/manage-account/adfixus-settings.png){zoomable="yes"}
...
Het dialoogvenster **[!UICONTROL Match keys]** wordt weergegeven. Schakel in of uit of werk de **[!UICONTROL Account ID]** for your [!UICONTROL AdFixus ID's] in of selecteer **[!UICONTROL Save]** om de wijzigingen te bevestigen.
...
>
>Op dit moment kunnen geen overeenkomende sleutels worden verwijderd als deze eenmaal aan uw account zijn toegevoegd.
...
Een succesdialoogvenster bevestigt dat de match-keys van uw account met succes zijn bijgewerkt.

![&#x200B; een succesdialoog die de de overeenkomstensleutels van uw rekening bevestigt wordt met succes bijgewerkt.](/help/assets/setup/manage-account/match-key-updated-successfully.png){zoomable="yes"}
