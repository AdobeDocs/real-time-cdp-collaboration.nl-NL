...
* **CSV Dossier**: Upload een Csv- dossier dat uw publieksgegevens voor snelle en ongecompliceerde gegevensopname bevat. Verwijs naar [&#x200B; CSV dossier voor publiek dat &#x200B;](./upload-csv-audience-sourcing.md) gids uploadt om begonnen te worden.
...
* **Snowflake**: Gebruik uw gegevenspakhuis van Snowflake om in publieksgegevens foutloos te trekken. Verwijs naar [&#x200B; vormen  [!DNL Snowflake]  voor publiek die &#x200B;](./configure-snowflake-audience-sourcing.md) gids aantrekken.
...
* [Overzicht van labels voor gegevensgebruik](https://experienceleague.adobe.com/nl/docs/experience-platform/data-governance/labels/overview){target="_blank"}
* [Verklarende woordenlijst met gegevensgebruikslabels](https://experienceleague.adobe.com/nl/docs/experience-platform/data-governance/labels/reference){target="_blank"}
...
**[!UICONTROL Source fields]** zijn naamruimten en kenmerken van Experience Platform. Deze omvatten zowel standaard [&#128279;](https://experienceleague.adobe.com/docs/experience-platform/identity/features/namespaces.html?lang=nl-NL#standard){target="_blank"} als [&#x200B; douane &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/identity/features/namespaces.html?lang=nl-NL#create-namespaces){target="_blank"} identiteitsnaamruimten. Zij omvatten ook profielattributen die in het [&#x200B; verenigingsschema &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/profile/union-schemas/union-schema.html?lang=nl-NL){target="_blank"} aanwezig zijn en tot de individuele klasse van het Profiel XDM behoren.
