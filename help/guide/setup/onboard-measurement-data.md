...
### Conversiedetails bewerken {#edit-conversion-details}

U kunt de volgende conversiegegevens van de gebeurtenis bijwerken:

| Veld | Beschrijving |
|-------------------|-------------|
| Conversietype | De categorie van de conversiegebeurtenis, zoals een bezoek, aankoop of aanmelding op de site. |
| Duplicatietoets | Identifier voor rijen in de gebeurtenisdataset die tot de zelfde omzettingsgebeurtenis (bijvoorbeeld, zelfde timestamp) behoren. Hiermee voorkomt u dubbele aantallen. |
| Conversiewaarde | De waarde die aan elke conversie is gekoppeld. |
...
### Voorwaarden bewerken {#edit-conditions}

De regels van de voorwaarde specificeren welke gegevensrijen van uw gebeurtenisdataset als omzettingen inbegrepen zijn. Werk deze regels zo nodig bij om ervoor te zorgen dat uw meting alleen de meest relevante gegevens voor uw analyse weerspiegelt.
...
## Metingsgegevens verwijderen {#delete-measurement-data}
