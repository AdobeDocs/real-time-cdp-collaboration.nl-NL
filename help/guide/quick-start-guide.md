...
Meer over aanvankelijke rekeningsopstelling leren, met inbegrip van hoe te om rollen te bepalen, het brandmerken activa te uploaden, en gelijke sleutels te vormen, zie de ](./setup/onboard-account.md#initial-account-setup){target="_blank"} gids van de 0} aanvankelijke rekeningsopstelling {.[
